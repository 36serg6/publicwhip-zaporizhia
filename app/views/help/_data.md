...
|mp_friends | підструктура, що містить кількісні показники спільних голосувань депутата з іншими депутатами|
...
Підструктура `mp_friends` містить інформацію про кількість спільних голосувань депутата з іншими депутатами, де :

| Параметр     | Опис |
|------------|------------|
|id | оперативний ідентифікатор депутата |
|friend\_deputy\_id | унікальний ідентифікатор депутата, для якого обраховується кількість спільних голосувань з поточним депутатом |
|count | обрахована кількість спільних голосувань |
|date\_mp\_friend | місяць, за який обраховано кількість спільних голосувань|
